...
export const api = {
    ...
    finance: {
        journalEntries: {
            ...
            reverse: (id: string) => request<any>(`/finance/journal-entries/${id}/reverse`, { method: 'POST' }),
        },
        accounts: {
            getAll: () => request<Array<any>>('/finance/accounts'),
            getById: (id: string) => request<any>(`/finance/accounts/${id}`),
            create: (data: any) => request<any>('/finance/accounts', { method: 'POST', body: JSON.stringify(data) }),
            update: (id: string, data: any) => request<any>(`/finance/accounts/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
        },
        payments: {
            getAll: () => request<Array<any>>('/finance/payments'),
            getById: (id: string) => request<any>(`/finance/payments/${id}`),
            create: (data: any) => request<any>('/finance/payments', { method: 'POST', body: JSON.stringify(data) }),
        },
        fiscalPeriods: {
            getAll: () => request<Array<any>>('/finance/fiscal-periods'),
            getById: (id: string) => request<any>(`/finance/fiscal-periods/${id}`),
            create: (data: any) => request<any>('/finance/fiscal-periods', { method: 'POST', body: JSON.stringify(data) }),
            update: (id: string, data: any) => request<any>(`/finance/fiscal-periods/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
            generate: (year: number) => request<any>(`/finance/fiscal-periods/generate/${year}`, { method: 'POST' }),
        },
        postingProfiles: {
            getAll: () => request<Array<any>>('/finance/posting-profiles'),
            getById: (id: string) => request<any>(`/finance/posting-profiles/${id}`),
            create: (data: any) => request<any>('/finance/posting-profiles', { method: 'POST', body: JSON.stringify(data) }),
            update: (id: string, data: any) => request<any>(`/finance/posting-profiles/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
            delete: (id: string) => request<any>(`/finance/posting-profiles/${id}`, { method: 'DELETE' }),
        },
        taxProfiles: {
            getAll: () => request<Array<any>>('/finance/tax-profiles'),
            getById: (id: string) => request<any>(`/finance/tax-profiles/${id}`),
            create: (data: any) => request<any>('/finance/tax-profiles', { method: 'POST', body: JSON.stringify(data) }),
            update: (id: string, data: any) => request<any>(`/finance/tax-profiles/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
            delete: (id: string) => request<any>(`/finance/tax-profiles/${id}`, { method: 'DELETE' }),
        },
        exchangeRates: {
            getAll: () => request<Array<any>>('/finance/exchange-rates'),
            getById: (id: string) => request<any>(`/finance/exchange-rates/${id}`),
            create: (data: any) => request<any>('/finance/exchange-rates', { method: 'POST', body: JSON.stringify(data) }),
            update: (id: string, data: any) => request<any>(`/finance/exchange-rates/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
            delete: (id: string) => request<any>(`/finance/exchange-rates/${id}`, { method: 'DELETE' }),
            sync: () => request<any>('/finance/exchange-rates/sync', { method: 'POST' }),
            fetchExternal: (date: string, code: string) => request<any>(`/finance/exchange-rates/external?date=${date}&code=${code}`),
        },
        cheques: {

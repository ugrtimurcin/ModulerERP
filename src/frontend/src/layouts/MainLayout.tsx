...
const navItems: NavItem[] = [
    ...
    },
    {
        ...
        children: [
            ...
            { labelKey: 'nav.stockLevels', href: '/inventory/levels' },
            { labelKey: 'nav.stockMovements', href: '/inventory/movements' },
    ...
    },
    {
        ...
        children: [
            ...
            { labelKey: 'nav.rfqs', href: '/procurement/rfqs' },
            { labelKey: 'nav.purchaseQuotes', href: '/procurement/purchase-quotes' },
            { labelKey: 'nav.purchaseOrders', href: '/procurement/purchase-orders' },
            { labelKey: 'nav.goodsReceipts', href: '/procurement/goods-receipts' },
            { labelKey: 'nav.qualityControl', href: '/procurement/qc' },
            { labelKey: 'nav.purchaseReturns', href: '/procurement/returns' },
        ],
    },
    {
